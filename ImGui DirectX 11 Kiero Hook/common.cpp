...
int AutoRequestTime = 40000;

std::string send_map_name = ""s;
...
std::string chatspammssage;


std::string kickspam_msg;
std::string kickspam_msg1;
std::string kickspam_msg2;
std::string kickspam_msg3;
std::string kickspam_msg4;

bool autokick1 = { false };
bool autocrash1 = { false };
bool autopopup1 = { false };
