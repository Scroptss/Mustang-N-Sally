						...
						if (enemy_active)
						{
							...
							if (rgb_enemy)
							{
								...
								if (Healthbars)
								{
									...
									draw_list->AddLine(ImVec2(screen[i][0] - (width[i] / 1.5) + 3, screen[i][1]), ImVec2(screen[i][0] - (width[i] / 1.5) + 3, head_screen[i][1]), ImColor(21, 21, 21, 235), 2);
								...
								if (skeleton_esp) {
									...
									//head line
									//draw_list->AddLine(ImVec2(j_neckpos_screen[i][0], j_neckpos_screen[i][1]), ImVec2(j_headpos_screen[i][0], j_headpos_screen[i][1]), ImColor(enemy_colors), boldness);
							...
							else
							{
								if (team[i] == false)
								{
									if (Healthbars)
									{
										...
										draw_list->AddLine(ImVec2(screen[i][0] - (width[i] / 1.5) + 3, screen[i][1]), ImVec2(screen[i][0] - (width[i] / 1.5) + 3, head_screen[i][1]), ImColor(21, 21, 21, 255), 2);
									...
									if (skeleton_esp) {
										//head line
										//draw_list->AddLine(ImVec2(j_neckpos_screen[i][0], j_neckpos_screen[i][1]), ImVec2(j_headpos[i][0], j_headpos[i][1]), ImColor(enemy_colors), boldness);
